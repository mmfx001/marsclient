...
const Navbar = ({ setLoggedInUser }) => {
    ...
    return (
        <nav className="bg-white text-white py-4 px-10 flex justify-between items-center shadow-lg">
            ...
            <div className="text-slate-500 flex items-center space-x-10">
                <Link to="/" className="hover:text-orange-500 transition duration-300">Home</Link>
                <Link to="/display" className="hover:text-orange-500 transition duration-300">Post</Link>
                <Link to="/shop" className="hover:text-orange-500 transition duration-300">Shop</Link>
            </div>

<div>
<Link to='/post'>
<button className='bg-orange-400 text-white w-32 h-8 rounded-xl'>Post</button>
</Link>
</div>
            {!loggedInUser ? (
